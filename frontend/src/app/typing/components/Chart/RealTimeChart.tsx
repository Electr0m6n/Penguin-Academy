...
export const RealTimeChart: React.FC<RealTimeChartProps> = ({
  ...
  return (
    <motion.div 
      ...
      className={`mt-4 rounded-xl p-3 w-full max-w-[85%] mx-auto bg-black/30 border border-white/10 ${codeMode ? 'mb-4' : 'mb-8'}`}
    ...
    >
      ...
      <div className={`flex items-center justify-center ${codeMode ? 'h-32 md:h-40' : 'h-48 md:h-64'}`}>
